...
const ConversationalForm = () => {
  ...
  }, [questions, formSubmissionId, headers, source, setLoading, setSubmitted]);
        ...
        >
          ...
          <CardContent sx={{ paddingBottom: 0 }}>
            <form aria-label='Booking Form' autoComplete='on' noValidate>
              {submitted && (
                <Prompt questionPrompt={LOCALIZED.SUBMISSION_MESSAGE} />
              )}
              ...
              {!submitted && (
                <>
                  <Stack spacing={2}>
                    <Prompt questionPrompt={currentQuestion?.prompt} />
                    <Answer
                      questionInputs={currentQuestion?.inputs}
                      errors={currentErrors}
                      onInputChange={handleAnswerInputChange}
                      onDateChange={handleAnswerDateChange}
                      services={services}
                    />
                  </Stack>
                  {/* Navigation Area */}
